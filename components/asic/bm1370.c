...
static uint8_t _send_init(uint64_t frequency, uint16_t asic_count)
{
    ...
    //unsigned char set_10_hash_counting[6] = {0x00, 0x10, 0x00, 0x0F, 0x0F, 0x0F}; //supposedly the "full" 32bit nonce range
...
task_result * BM1370_proccess_work(void * pvParameters)
{
    ...
    ESP_LOGI(TAG, "Job ID: %02X, Ver: %08" PRIX32, job_id, version_bits);
